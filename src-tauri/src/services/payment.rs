...
use crate::consts::{
    API_HEALTH_CHECK_PING_CLIENT, API_PAYMENT_CREATE, API_PAYMENT_CURRENCIES, API_PAYMENT_HISTORY,
...
impl PaymentService {
    ...
    pub async fn get_payment_status(
        ...
        Self::client(config_store)
            .get(&format!("{}/{}", API_PAYMENT_STATUS, payment_id))
            .await
    }
